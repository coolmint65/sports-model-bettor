"""Legacy path — moved to ``engine.sports.nhl.calibration`` (A6 STUB).

Old callers using ``engine.nhl_calibration`` keep working via this
re-export. Update your imports when convenient — the legacy path
will be removed once no in-tree callers reference it.
"""
from engine.sports.nhl.calibration import *  # noqa: F401, F403
from engine.sports.nhl import calibration as _mod  # noqa: F401
