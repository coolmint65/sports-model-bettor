"""Baseball framework → unified adapter (college today, KBO/NPB later).

Same shape as football: per-league DB at ``data/baseball/{league}.db``,
games table with home_score/away_score, picks with ML / SPREAD (run-line
equivalent) / TOTAL.
"""
