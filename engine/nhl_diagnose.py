"""Legacy path — moved to ``engine.sports.nhl.diagnose`` (A6 STUB).

Old callers using ``engine.nhl_diagnose`` keep working via this
re-export. Update your imports when convenient — the legacy path
will be removed once no in-tree callers reference it.
"""
from engine.sports.nhl.diagnose import *  # noqa: F401, F403
from engine.sports.nhl import diagnose as _mod  # noqa: F401
