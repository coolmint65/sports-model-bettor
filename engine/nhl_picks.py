"""Legacy path — moved to ``engine.sports.nhl.picks`` (A6 STUB).

Old callers using ``engine.nhl_picks`` keep working via this
re-export. Update your imports when convenient — the legacy path
will be removed once no in-tree callers reference it.
"""
from engine.sports.nhl.picks import *  # noqa: F401, F403
from engine.sports.nhl import picks as _mod  # noqa: F401
