...
Usage:
    from engine.nba_predict import predict_full, predict_full_matchup
...
def _check_back_to_back(team_abbr: str) -> bool:
    ...
    from .nba_q1_predict import _check_back_to_back as _q1_b2b
...
def predict_full(home_abbr: str, away_abbr: str,
    ...
    if _ROSTER_ON and not backtest:
        try:
            from .nba_injuries import compute_q1_adjustment
            ...
            if home.get("team_id"):
                ...
                home_roster_adj = {
                    ...
                    "out_players": q1_h.get("out_players") or [],
                }
            if away.get("team_id"):
                ...
                away_roster_adj = {
                    ...
                    "out_players": q1_a.get("out_players") or [],
                }
    ...
    margin_sigma = float(_get_flag("NBA_MARGIN_STD", MARGIN_STD_DEV, sport="nba"))
    ...
    total_sigma = float(_get_flag("NBA_TOTAL_STD", TOTAL_STD_DEV, sport="nba"))
    over_prob = None
