...
DB_PATH = Path(__file__).resolve().parents[3] / "data" / "nhl.db"
...
def _init_schema(conn: sqlite3.Connection) -> None:
    ...
    -- just fired picks), removing the selection-bias gap that lifetime
    -- ROI showed across all sports.
    ...
    CREATE INDEX IF NOT EXISTS idx_nhl_pred_signals_sport_market
        ON prediction_signals(sport, market);
    CREATE INDEX IF NOT EXISTS idx_nhl_pred_signals_date
