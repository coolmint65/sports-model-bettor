...
try:
    from .db import get_conn, get_nhl_team_by_abbr, get_team_games_in_range
except ImportError:
    from engine.sports.nhl.db import get_conn, get_nhl_team_by_abbr, get_team_games_in_range
