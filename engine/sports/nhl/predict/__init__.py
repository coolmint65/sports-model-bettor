...
def _compute_blowout_tendency(team_abbr: str) -> dict:
    ...
    try:
        from ..db import get_nhl_team_by_abbr, get_conn
...
def _predict_matchup_inner(home_key: str, away_key: str,
    ...
    # Use mc_constants.nhl_home_edge_goals so factor + MC pull from
    # the same fitted source. HOME_EDGE module literal stays as a
    # last-resort default if the lookup fails.
    try:
        from ...mc_constants import nhl_home_edge_goals as _nhl_he
        home_edge = _nhl_he()
    except Exception:
        home_edge = HOME_EDGE
    ...
    try:
        from ..db import (get_nhl_team_by_abbr, get_team_goalies,
                             get_h2h_nhl, get_recent_nhl_games, get_goalie_stats)
        from ..calibration import get_calibrated_home_edge, get_total_adjustment
    ...
    try:
        from ..calibration import get_total_adjustment
    ...
    try:
        from ..db import get_p1_stats, get_nhl_team_by_abbr as _p1_team_lookup
...
from ..picks import generate_nhl_picks, generate_nhl_picks_with_context  # noqa: F401, E402
