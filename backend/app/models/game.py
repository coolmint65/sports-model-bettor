...
class Game(TimestampMixin, Base):
    ...
    # 2nd Period Total
    period2_total_line: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period2_over_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period2_under_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    # 2nd Period Winner (3-way)
    period2_home_ml: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period2_away_ml: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period2_draw_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    # 2nd Period Spread
    period2_spread_line: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period2_home_spread_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period2_away_spread_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    # 3rd Period Total
    period3_total_line: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period3_over_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period3_under_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    # 3rd Period Winner (3-way)
    period3_home_ml: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period3_away_ml: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period3_draw_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    # 3rd Period Spread
    period3_spread_line: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period3_home_spread_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
    period3_away_spread_price: Mapped[Optional[float]] = mapped_column(Float, nullable=True)
